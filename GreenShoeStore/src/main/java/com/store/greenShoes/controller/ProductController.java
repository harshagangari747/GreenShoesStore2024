...
public class ProductController {
	...
	private ResponseEntity<Object> postProduct(@RequestPart("image")List<MultipartFile> productImages,@RequestPart @Valid ProductDTO product) {
		try
		{
			ProductDTO p =  productService.postProduct(productImages,product);	
	...
	private ResponseEntity<ProductDTO> updateProduct(@PathVariable("id") Long id, @RequestBody ProductDTO product) {
		try {
